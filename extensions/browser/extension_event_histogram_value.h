...
enum HistogramValue {
  ...
  FYDEOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 550,
  FYDEOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 551,
  FYDEOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 552,
  ARC_APPS_PRIVATE_ON_REMOVED = 553,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 554,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 555,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 556,
  FYDEOS_LICENSE_INVALID_NOTIFICATION = 557,
  FYDEOS_LICENSE_VALID_NOTIFICATION = 558,
