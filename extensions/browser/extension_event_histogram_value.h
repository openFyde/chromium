...
enum HistogramValue {
  ...
  FYDEOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 563,
  FYDEOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 564,
  FYDEOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 565,
  ...
  FYDEOS_LICENSE_INVALID_NOTIFICATION = 570,
  FYDEOS_LICENSE_VALID_NOTIFICATION = 571,
