...
enum HistogramValue {
  ...
  FYDEOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 567,
  FYDEOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 568,
  FYDEOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 569,
  ARC_APPS_PRIVATE_ON_REMOVED = 570,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 571,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 572,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 573,
  FYDEOS_LICENSE_INVALID_NOTIFICATION = 574,
  FYDEOS_LICENSE_VALID_NOTIFICATION = 575,
