...
enum HistogramValue {
  ...
  FYDEOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 557,
  FYDEOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 558,
  FYDEOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 559,
  ARC_APPS_PRIVATE_ON_REMOVED = 560,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 561,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 562,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 563,
  FYDEOS_LICENSE_INVALID_NOTIFICATION = 564,
  FYDEOS_LICENSE_VALID_NOTIFICATION = 565,
