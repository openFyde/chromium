...
enum HistogramValue {
  ...
  FYDEOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 573,
  FYDEOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 574,
  FYDEOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 575,
  ARC_APPS_PRIVATE_ON_REMOVED = 576,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 577,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 578,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 579,
  FYDEOS_LICENSE_INVALID_NOTIFICATION = 580,
  FYDEOS_LICENSE_VALID_NOTIFICATION = 581,
