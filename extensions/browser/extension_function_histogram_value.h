...
enum HistogramValue {
  ...
  NATIVE_WINDOWS_GET = 1954,
  NATIVE_WINDOWS_GETALL = 1955,
  NATIVE_WINDOWS_UPDATE = 1956,
  NATIVE_WINDOWS_REMOVE = 1957,
  NATIVE_WINDOWS_CREATE = 1958,
  APP_MANAGEMENT_GETAPPLIST = 1959,
  APP_MANAGEMENT_INSTALLWEBAPP = 1960,
  APP_MANAGEMENT_INSTALLARCAPP = 1961,
  COMMAND_LINE_HASSWITCH = 1962,
  COMMAND_LINE_REMOVESWITCH = 1963,
  COMMAND_LINE_ADDSWITCH = 1964,
  APP_MANAGEMENT_GETARCPOLICY = 1965,
  SHELL_SYNC_EXEC = 1966,
  SHELL_ASYNC_EXEC = 1967,
  SHELL_GET_TASK_STATE = 1968,
  SHELL_GET_TASK_OUTPUT = 1969,
  SHELL_GET_DAEMON_STATE = 1970,
  SHELL_FORCE_CLOSE_TASK = 1971,
  FYDEOS_ARC_STATUS_GET = 1972,
  INPUT_IME_SHOW_FYDE_LANGUAGE_STATE = 1973,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1974,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1975,
  FYDEOS_PRIVATE_GET_FYDEOS_INFO = 1976,
  LICENSE_MANAGEMENT_REFRESH = 1977,
