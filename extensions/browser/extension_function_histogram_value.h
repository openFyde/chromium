...
enum HistogramValue {
  ...
  NATIVE_WINDOWS_GET = 1890,
  NATIVE_WINDOWS_GETALL = 1891,
  NATIVE_WINDOWS_UPDATE = 1892,
  NATIVE_WINDOWS_REMOVE = 1893,
  NATIVE_WINDOWS_CREATE = 1894,
  APP_MANAGEMENT_GETAPPLIST = 1895,
  APP_MANAGEMENT_INSTALLWEBAPP = 1896,
  APP_MANAGEMENT_INSTALLARCAPP = 1897,
  COMMAND_LINE_HASSWITCH = 1898,
  COMMAND_LINE_REMOVESWITCH = 1899,
  COMMAND_LINE_ADDSWITCH = 1900,
  APP_MANAGEMENT_GETARCPOLICY = 1901,
  SHELL_SYNC_EXEC = 1902,
  SHELL_ASYNC_EXEC = 1903,
  SHELL_GET_TASK_STATE = 1904,
  SHELL_GET_TASK_OUTPUT = 1905,
  SHELL_GET_DAEMON_STATE = 1906,
  SHELL_FORCE_CLOSE_TASK = 1907,
  FYDEOS_ARC_STATUS_GET = 1908,
  INPUT_IME_SHOW_FYDE_LANGUAGE_STATE = 1909,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1910,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1911,
  FYDEOS_PRIVATE_GET_FYDEOS_INFO = 1912,
  LICENSE_MANAGEMENT_REFRESH = 1913,
