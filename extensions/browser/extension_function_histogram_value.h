...
enum HistogramValue {
  ...
  NATIVE_WINDOWS_GET = 1839,
  NATIVE_WINDOWS_GETALL = 1840,
  NATIVE_WINDOWS_UPDATE = 1841,
  NATIVE_WINDOWS_REMOVE = 1842,
  NATIVE_WINDOWS_CREATE = 1843,
  APP_MANAGEMENT_GETAPPLIST = 1844,
  APP_MANAGEMENT_INSTALLWEBAPP = 1845,
  APP_MANAGEMENT_INSTALLARCAPP = 1846,
  COMMAND_LINE_HASSWITCH = 1847,
  COMMAND_LINE_REMOVESWITCH = 1848,
  COMMAND_LINE_ADDSWITCH = 1849,
  APP_MANAGEMENT_GETARCPOLICY = 1850,
  SHELL_SYNC_EXEC = 1851,
  SHELL_ASYNC_EXEC = 1852,
  SHELL_GET_TASK_STATE = 1853,
  SHELL_GET_TASK_OUTPUT = 1854,
  SHELL_GET_DAEMON_STATE = 1855,
  SHELL_FORCE_CLOSE_TASK = 1856,
  FYDEOS_ARC_STATUS_GET = 1857,
  INPUT_IME_SHOW_FYDE_LANGUAGE_STATE = 1858,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1859,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1860,
  FYDEOS_PRIVATE_GET_FYDEOS_INFO = 1861,
  LICENSE_MANAGEMENT_REFRESH = 1862,
