...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1595,
  NATIVE_WINDOWS_GETALL = 1596,
  NATIVE_WINDOWS_UPDATE = 1597,
  NATIVE_WINDOWS_REMOVE = 1598,
  NATIVE_WINDOWS_CREATE = 1599,
  APP_MANAGEMENT_GETAPPLIST = 1600,
  APP_MANAGEMENT_INSTALLWEBAPP = 1601,
  APP_MANAGEMENT_INSTALLARCAPP = 1602,
  COMMAND_LINE_HASSWITCH = 1603,
  COMMAND_LINE_REMOVESWITCH = 1604,
  COMMAND_LINE_ADDSWITCH = 1605,
  APP_MANAGEMENT_GETARCPOLICY = 1606,
  SHELL_SYNC_EXEC = 1607,
  SHELL_ASYNC_EXEC = 1608,
  SHELL_GET_TASK_STATE = 1609,
  SHELL_GET_TASK_OUTPUT = 1610,
  SHELL_GET_DAEMON_STATE = 1611,
  SHELL_FORCE_CLOSE_TASK = 1612,
  //---***FYDEOS END***---
