...
enum HistogramValue {
  ...
  NATIVE_WINDOWS_GET = 1940,
  NATIVE_WINDOWS_GETALL = 1941,
  NATIVE_WINDOWS_UPDATE = 1942,
  NATIVE_WINDOWS_REMOVE = 1943,
  NATIVE_WINDOWS_CREATE = 1944,
  APP_MANAGEMENT_GETAPPLIST = 1945,
  APP_MANAGEMENT_INSTALLWEBAPP = 1946,
  APP_MANAGEMENT_INSTALLARCAPP = 1947,
  COMMAND_LINE_HASSWITCH = 1948,
  COMMAND_LINE_REMOVESWITCH = 1949,
  COMMAND_LINE_ADDSWITCH = 1950,
  APP_MANAGEMENT_GETARCPOLICY = 1951,
  SHELL_SYNC_EXEC = 1952,
  SHELL_ASYNC_EXEC = 1953,
  SHELL_GET_TASK_STATE = 1954,
  SHELL_GET_TASK_OUTPUT = 1955,
  SHELL_GET_DAEMON_STATE = 1956,
  SHELL_FORCE_CLOSE_TASK = 1957,
  FYDEOS_ARC_STATUS_GET = 1958,
  INPUT_IME_SHOW_FYDE_LANGUAGE_STATE = 1959,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1960,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1961,
  FYDEOS_PRIVATE_GET_FYDEOS_INFO = 1962,
  LICENSE_MANAGEMENT_REFRESH = 1963,
