...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1650,
  NATIVE_WINDOWS_GETALL = 1651,
  NATIVE_WINDOWS_UPDATE = 1652,
  NATIVE_WINDOWS_REMOVE = 1653,
  NATIVE_WINDOWS_CREATE = 1654,
  APP_MANAGEMENT_GETAPPLIST = 1655,
  APP_MANAGEMENT_INSTALLWEBAPP = 1656,
  APP_MANAGEMENT_INSTALLARCAPP = 1657,
  COMMAND_LINE_HASSWITCH = 1658,
