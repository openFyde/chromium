...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1726,
  NATIVE_WINDOWS_GETALL = 1727,
  NATIVE_WINDOWS_UPDATE = 1728,
  NATIVE_WINDOWS_REMOVE = 1729,
  NATIVE_WINDOWS_CREATE = 1730,
  APP_MANAGEMENT_GETAPPLIST = 1731,
  APP_MANAGEMENT_INSTALLWEBAPP = 1732,
  APP_MANAGEMENT_INSTALLARCAPP = 1733,
  COMMAND_LINE_HASSWITCH = 1734,
  COMMAND_LINE_REMOVESWITCH = 1735,
  COMMAND_LINE_ADDSWITCH = 1736,
  APP_MANAGEMENT_GETARCPOLICY = 1737,
  SHELL_SYNC_EXEC = 1738,
  SHELL_ASYNC_EXEC = 1739,
  SHELL_GET_TASK_STATE = 1740,
