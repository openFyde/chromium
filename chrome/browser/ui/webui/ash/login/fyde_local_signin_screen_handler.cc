...
void FydeLocalSigninScreenHandler::DeclareLocalizedValues(
  ...
  builder->Add("fydeosLocalSigninInvalidPasswordTooShort",
...
void FydeLocalSigninScreenHandler::DoCompleteLogin(const bool newUser,
  ...
  user_context.SetFydeLocalPasswordInput(LocalPasswordInput{password});
...
base::WeakPtr<FydeLocalSigninView> FydeLocalSigninScreenHandler::AsWeakPtr() {
