...
#ifndef CHROME_BROWSER_UI_ASH_TOUCH_SELECTION_MENU_RUNNER_CHROMEOS_H_
#define CHROME_BROWSER_UI_ASH_TOUCH_SELECTION_MENU_RUNNER_CHROMEOS_H_
...
#endif  // CHROME_BROWSER_UI_ASH_TOUCH_SELECTION_MENU_RUNNER_CHROMEOS_H_
