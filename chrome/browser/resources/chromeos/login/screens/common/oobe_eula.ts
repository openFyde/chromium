...
const EulaScreenBase = mixinBehaviors(
    [LoginScreenBehavior, MultiStepBehavior], OobeI18nMixin(PolymerElement)) as {
    new(): PolymerElement & LoginScreenBehaviorInterface & MultiStepBehaviorInterface & OobeI18nMixinInterface;
  };
...
class EulaScreen extends EulaScreenBase {
  ...
  onBeforeShow(data: { backButtonHidden: boolean }) {
