...
void LicenseValidator::StartValidate(const std::string& id,
                                     absl::optional<std::string> license,
    SuccessCallback<absl::optional<base::Value>> success_callback,
  ...
  absl::optional<int> log_out_interval;
  ...
  if (!signature_verifier_.VerifyInit(
    ...
    base::as_bytes(base::make_span(std::string(
