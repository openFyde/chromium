...
class CHROMEOS_EXPORT LicenseManager : public ::ash::LoginState::Observer {
 ...
 private:
  ...
  void OnFetchedOfflineLicense(absl::optional<fydeos::ash::ShellState> state);
  void IGetId();
  void IGetSerialNumber();
  void NotifyObservers();
  void OnGotId(absl::optional<fydeos::ash::ShellState> state);
  void OnGotSerialNumber(absl::optional<fydeos::ash::ShellState> state);
  void IValidateLicense(absl::optional<std::string> license);
  void ISaveLocalLicenseString(absl::optional<base::Value> license);
  void IStoreLicense(absl::optional<base::Value> license);
  void OnStoredLicense(absl::optional<fydeos::ash::ShellState> state);
  ...
  void OnInvalid();
  void OnValid(absl::optional<base::Value> license);
  void SkipOnline();
