...
void LicenseManager::OnGotId(absl::optional<ShellState> state) {
...
void LicenseManager::OnGotSerialNumber(absl::optional<ShellState> state) {
  if (!state || state->code != 0) {
...
void LicenseManager::OnValid(absl::optional<base::Value> license) {
...
void LicenseManager::IValidateLicense(absl::optional<std::string> license) {
...
void LicenseManager::ISaveLocalLicenseString(absl::optional<base::Value> license) {
...
void LicenseManager::IStoreLicense(absl::optional<base::Value> license) {
...
void LicenseManager::OnStoredLicense(absl::optional<ShellState> state) {
  if ( state && (state->code != 0))
...
void LicenseManager::OnFetchedOfflineLicense(absl::optional<ShellState> state) {
  if (!state) {
...
void LicenseManager::IFetchOnlineLicense() {
  ::ash::NetworkPortalDetector::CaptivePortalStatus captivePortalStatus =
    ::ash::network_portal_detector::GetInstance()->GetCaptivePortalStatus();
