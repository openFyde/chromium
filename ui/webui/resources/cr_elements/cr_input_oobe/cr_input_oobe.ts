...
import './cr_input_oobe_style.css.js';

import {assert} from '//resources/js/assert_ts.js';
import {PolymerElement} from '//resources/polymer/v3_0/polymer/polymer_bundled.min.js';

import {getTemplate} from './cr_input_oobe.html.js';
 ...
 *   </cr-input>
 */
export interface CrInputOobeElement {
  $: {
    error: HTMLElement,
    label: HTMLElement,
...
export class CrInputOobeElement extends PolymerElement {
  static get is() {
    return 'cr-input-oobe';
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'cr-input-oobe': CrInputOobeElement;
  }
}

customElements.define(CrInputOobeElement.is, CrInputOobeElement);
